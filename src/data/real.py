...
class DataFetcher:
    ...
    def fetch(self, ticker: str, period: str = "1y", source: str = "auto") -> Optional[pd.DataFrame]:
        """
    ...
    def fetch_all(self, tickers: List[str], period: str = "1y", source: str = "auto") -> Dict[str, pd.DataFrame]:
...
def get_data(tickers: List[str], period: str = "1y", source: str = "auto") -> Dict[str, pd.DataFrame]:
