...
def generate_trading_signals(
    data: pd.DataFrame, strategy: str = "sma_crossover", **params
) -> pd.Series:
    """
    生成交易信号
...
STRATEGIES = {
    "sma_crossover": {
        "name": "均线交叉",
        "params": {"fast_period": (5, 50, 20), "slow_period": (20, 200, 50)},
    },
    "rsi": {
        "name": "RSI 超买超卖",
        "params": {"period": (5, 30, 14), "oversold": (10, 40, 30), "overbought": (60, 90, 70)},
    },
    "macd": {
        "name": "MACD",
        "params": {"fast": (5, 20, 12), "slow": (15, 50, 26), "signal": (5, 15, 9)},
    },
    "bollinger": {"name": "布林带", "params": {"period": (10, 50, 20), "std_dev": (1.0, 3.0, 2.0)}},
    "momentum": {
        "name": "动量",
        "params": {"lookback": (5, 50, 20), "threshold": (0.01, 0.1, 0.02)},
    },
    "mean_reversion": {
        "name": "均值回归",
        "params": {"period": (10, 50, 20), "std_dev": (1.0, 3.0, 2.0)},
    },
    "breakout": {"name": "突破", "params": {"lookback": (10, 50, 20)}},
}
