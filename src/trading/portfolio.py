...
class Portfolio:
    ...
    def buy(self, ticker: str, quantity: int, price: float, commission: float = 0.001) -> bool:
        """
        买入
    ...
    def sell(self, ticker: str, quantity: int, price: float, commission: float = 0.001) -> bool:
        """
        卖出
    ...
    def equal_weight(
        ...
        for ticker in current_tickers - target_tickers:
            if ticker in portfolio.positions:
                ...
                portfolio.sell(
                    ticker, pos.quantity, target_prices.get(ticker, pos.current_price), commission
                )
