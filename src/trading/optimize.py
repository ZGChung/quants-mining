    ...
    def optimize(
        ...
        for i, combo in enumerate(combinations):
            ...
            try:
                ...
                print(f"  [{i+1}/{len(combinations)}] {params} -> Sharpe: {record['sharpe_ratio']:.3f}, Return: {record['total_return']:.2%}")
...
def run_optimization_example():
    ...
    for i, r in enumerate(result.all_results[:5]):
        print(f"{i+1}. Sharpe: {r['sharpe_ratio']:.3f}, Return: {r['total_return']:.2%}, Params: {r['params']}")
