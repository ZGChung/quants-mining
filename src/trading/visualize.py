...
def plot_backtest_results(
    ...
    try:
        ...
        ax1.axhline(equity_curve.iloc[0], color='gray', linestyle='--', alpha=0.7, label='Initial Capital')
        ax1.fill_between(equity_curve.index, equity_curve.values, equity_curve.iloc[0], 
        ...
        ax2.plot(cumulative_returns.index, cumulative_returns.values * 100, 
                linewidth=2, color='#A23B72')
        ax2.axhline(0, color='gray', linestyle='--', alpha=0.7)
        ax2.fill_between(cumulative_returns.index, cumulative_returns.values * 100, 0,
